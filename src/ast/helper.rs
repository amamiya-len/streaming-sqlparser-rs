...
/// # Example
/// ```rust
/// use sqlparser::ast::helpers::stmt_create_table::CreateStreamBuilder;
/// use sqlparser::ast::{ColumnDef, DataType, Ident, ObjectName};
/// let builder = CreateStreamBuilder::new(ObjectName(vec![Ident::new("table_name")]))
///    .if_not_exists(true)
...
impl TryFrom<Statement> for CreateStreamBuilder {
...
#[cfg(test)]
mod tests {
    use crate::ast::helpers::stmt_create_table::CreateStreamBuilder;
    ...
    pub fn test_from_valid_statement() {
        ...
        assert_eq!(builder, CreateStreamBuilder::try_from(stmt).unwrap());
    }
    ...
    pub fn test_from_invalid_statement() {
        ...
        assert_eq!(
            CreateStreamBuilder::try_from(stmt).unwrap_err(),
